<template>
    <div class="venuePage">
        <div style="width: 1200px;margin: auto;">
            <img style="width: 100%;" src="../assets/img/points.png" />
        </div>
...
<style>
    ...
    .venuePage .venueContainer .baseMessage .left,.venuePage .venueContainer .baseMessage .right{
        float: left;
        color: #fff;
    }
