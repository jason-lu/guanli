    ...
    <div style="width: 100%; height: 100%; position: relative;">
        <div id="container-left">
            ...
            <div id="red-content">
                <p> 伤亡：{{injureRed}} </p>
                <p>积分： 0</p>
                <el-table :data="redTeam" style="width: 80%">
            ...
            <div style="margin: 30px;">
                <EchartVue id="mychart" :options="options" width="80%"></EchartVue>
            </div>
        ...
        <div id="container-right">
            ...
            <div style="margin: 30px;">
                <EchartVue id="mychart2" :options="options2" width="80%"></EchartVue>
            </div>
        </div>
        <div
            style="height: 200px; width: 300px; background-color: #000000; z-index:10; position: relative; top:0; margin: auto;">
        </div>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                injureRed: 0,
                redTeam: [
                    { player: "队员1", equipment: "枪支1", status: '使用中', remaining: "20" },
                    { player: "队员2", equipment: "枪支2", status: '使用中', remaining: "21" },
                    { player: "队员3", equipment: "枪支3", status: '使用中', remaining: "25" },
                    { player: "队员4", equipment: "枪支4", status: '使用中', remaining: "23" },
                    { player: "队员5", equipment: "枪支5", status: '使用中', remaining: "24" },
                ],
                options: {
                    title: {
                        text: '红队数据统计',
