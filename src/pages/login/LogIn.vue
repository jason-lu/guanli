  ...
  <div class="login">
    <el-tabs v-model="activeName" :stretch=stretch>
      <el-tab-pane label="密码登录" name="first">
        <el-form ref="passwdLoginForm" status-icon :model="passwdLoginForm" :rules="rules" label-width="80px">
          <el-form-item label="用户" prop="phone">
            <el-input @keyup.enter.native="login" v-model="passwdLoginForm.phone" placeholder="请输入手机号码"></el-input>
          </el-form-item>
          <el-form-item label="密码" prop="passwd">
            <el-input id="pwd" @keyup.enter.native="login" v-model="passwdLoginForm.passwd" type="password"
          ...
          <el-form-item label="图片验证" prop="picCode">
            <el-row>
              <el-col :span="16">
                <el-input v-model="passwdLoginForm.picCode" placeholder="请输入验证码">
                </el-input>
              </el-col>
              <el-col :span="8">
                <img @click="getPicCode" class="vCodeImg" alt="稍后重试" title="点击切换验证码" :src="picCodeSrc" />
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="login('passwdLoginForm')">登录</el-button>
      ...
      <el-tab-pane label="短信登录" name="second">
        <el-form ref="msgLoginForm" status-icon :model="msgLoginForm" :rules="rules" label-width="80px">
          <el-form-item label="手机号码" prop="phone2">
            <el-input v-model="msgLoginForm.phone2" placeholder="请输入手机号码"></el-input>
          </el-form-item>
          <el-form-item label="短信验证" prop="validateNo">
            <el-row>
              <el-col :span="16">
                <el-input @keyup.enter.native="login" v-model="msgLoginForm.validateNo" placeholder="请输入短信验证码">
                </el-input>
              </el-col>
              <el-col :span="8">
                <el-button @click="getMsgCode" :disabled="disabled" type="primary" plain class="getcodebtn">
                  {{codeValue}}</el-button>
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="login('msgLoginForm')">登录</el-button>
  ...
  export default {
    data() {
      ...
      var checkPhone = (rule, value, callback) => {
        this.$http.post('member/validatePhone', qs.stringify({
    ...
    methods: {
      ...
      async login(form) {
        try {
          ...
          const para = form == 'passwdLoginForm' ? qs.stringify(this.passwdLoginForm) : qs.stringify({
            ...this.msgLoginForm,
            phone: this.msgLoginForm.phone2
          })
          ...
          if (data.respBody.isSuccess === 'true') {
            ...
            let username = JSON.parse(atob(token.split('.')[1])).name 
